...
import com.weatherapp.android.whatstheweather.adaptors.FavoriteLocationAdaptor;
...
import com.weatherapp.android.whatstheweather.utils.DataLayoutSetter;
import com.weatherapp.android.whatstheweather.utils.DatabaseHandler;
import com.weatherapp.android.whatstheweather.utils.ExtractData;
import com.weatherapp.android.whatstheweather.utils.JSONFileReader;
import com.weatherapp.android.whatstheweather.utils.LocationDataProcessor;
import com.weatherapp.android.whatstheweather.utils.LocationServices;
...
public class MainActivity extends AppCompatActivity implements RecyclerViewClickListener {
    ...
    private void setupFavLocationsNavigationDrawer(final Context context, final Activity activity) {
        ...
        findViewById(R.id.addLocation).setOnClickListener(v -> {
            removeLocation = false;
            findViewById(R.id.doneRemovingLocations).setVisibility(View.GONE);
        ...
        findViewById(R.id.removeLocation).setOnClickListener(v -> {
            removeLocation = true;
        ...
        findViewById(R.id.doneRemovingLocations).setOnClickListener(v -> {
            removeLocation = false;
